    ...
    return(
        <div className="grid grid-cols-[40%,60%] mt-5 ml-20 mr-18">
            <div className="flex flex-col justify-center space-y-8">
                <div className="flex">
                    <span className="flex bg-[#e1edff] text-blue-600 font-semibold px-6 py-2 rounded-md">Sale 70%</span>
                </div>
                ...
                <div>
                    <Button className="space-x-4 not rounded-none py-10 px-7">
                        <ShoppingCart/>
                        <Link href="/products" className="font-bold text-lg"><p>Start</p><p>Shopping</p></Link>
                    </Button>
                </div>
