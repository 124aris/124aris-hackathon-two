...
export default  function Secondsection() {
    return(
        <div className="py-32">
            ...
            <div className="flex justify-center space-x-8 items-stretch py-8">
                ...
                <div className="flex space-x-4">
                    <div className="flex flex-col bg-[#efe1c7] justify-end">
                        <div className="ml-5 mb-4">
                            ...
                            <span className="font-normal text-base">$100.00</span>
                    ...
                    <div className="flex flex-col bg-[#d7d7d9] justify-end">
                        <div className="ml-5 mb-2">
                            ...
                            <span className="font-normal text-base">$225.00</span>
                            <span className="text-lg font-semibold ml-2">$190.00</span>
                            </div>
